...
(function (SampleData) {
    ...
    SampleData.chartClassExpected = {
        lineChart: 'nv-lineChart',
        discreteBarChart: 'nv-discreteBarWithAxes',
        pieChart: 'nv-pieChart',
        scatterChart: 'nv-scatterChart',
        multiBarChart: 'nv-multiBarWithLegend',
        multiBarHorizontalChart: 'nv-multiBarHorizontalChart',
        candlestickBarChart: 'nv-historicalBarChart',
        ohlcBarChart: 'nv-historicalBarChar',
        boxPlotChart: 'nv-boxPlotWithAxes',
        multiChart: 'multiChart',
        sunburstChart: 'nv-sunburst',
        stackedAreaChart: 'nv-stackedAreaChart',
        cumulativeLineChart: 'nv-cumulativeLine',
        historicalBarChart: 'nv-historicalBarChart',
        parallelCoordinates: 'nv-parallelCoordinates',
        sparklinePlus: 'nv-sparklineplus',
        bulletChart: 'nv-bulletChart',
        linePlusBarWithFocusChart: 'nv-linePlusBar',
        forceDirectedGraph: 'nv-force-node'
    };
})(SampleData = exports.SampleData || (exports.SampleData = {}));
