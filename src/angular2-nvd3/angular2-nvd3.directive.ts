import { Directive, ElementRef, Input, OnChanges, AfterViewInit, OnDestroy } from '@angular/core';
import * as d3 from 'd3';
import * as nv from 'nvd3';

@Directive({ selector: '[appNvD3]' })
export class NvD3Directive implements OnChanges, AfterViewInit, OnDestroy {
    @Input()
    private options: any;
    ...
    private updateWithOptions(options) {
        ...
        if (!this.isViewInitialize || !options) { return; };
